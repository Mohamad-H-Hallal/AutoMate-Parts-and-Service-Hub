...
public class FileUploaderClass {
    ...
    public static void uploadFile(String filePath,String name, String folder_name,  onSuccessfulTask task) {
        try {
            ...
            Call<String> call = apiInterface.UploadFile(body, folder);
